...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  const navigation = [
    ...
    { name: 'Visual Search', href: '/visual-search', icon: MagnifyingGlassIcon },
    { name: 'Advanced Search', href: '/advanced-search', icon: SparklesIcon },
    { name: 'Recommendations', href: '/recommendations', icon: LightBulbIcon },
    { name: 'Content Analysis', href: '/content-analysis', icon: ChartPieIcon },
