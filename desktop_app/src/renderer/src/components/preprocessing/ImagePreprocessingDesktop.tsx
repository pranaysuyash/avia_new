...
const ImagePreprocessingDesktop: React.FC = () => {
  ...
  const selectImageFromSystem = async () => {
  ...
  // Save processed image to system
  const saveProcessedImage = async () => {
    if (!processedImage || !window.electron?.dialog) return;
  ...
  return (
    <Box sx={{ p: 3, height: '100vh', overflow: 'auto' }}>
      <Typography variant="h4" gutterBottom>
        Advanced Image Preprocessing - Desktop
      </Typography>
              ...
              <CardContent>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <IconButton onClick={saveProcessedImage} disabled={!processedImage}>
                      <FolderOpen />
                    </IconButton>
...
export default ImagePreprocessingDesktop;