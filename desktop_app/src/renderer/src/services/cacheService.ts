/**
 * Cache Service - Electron Desktop Version
...
export class CacheService {
  ...
  /**
   * Export cache statistics for desktop app
   */
  ...
  /**
   * Save cache report to file (Electron specific)
   */
  async saveCacheReport(stats: CacheStats): Promise<void> {
    const report = this.exportCacheStats(stats);
