    ...
    <AppShell>
      ...
      >
        ...
        <Card className="p-6 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Button 
              className="h-20 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 flex-col"
              onClick={() => navigate('/media-processing')}
            >
            ...
            <Button 
              variant="outline" 
              className="h-20 border-2 flex-col hover:bg-purple-50 hover:border-purple-300"
              onClick={() => {
                // Navigate to live processing or show coming soon
                alert('Live AI Processing - Coming Soon!');
              }}
            >
            ...
            <Button 
              variant="outline" 
              className="h-20 border-2 flex-col hover:bg-green-50 hover:border-green-300"
              onClick={() => {
                // Navigate to AI model hub or show coming soon
                alert('AI Model Hub - Coming Soon!');
              }}
            >
            ...
            <Button 
              variant="outline" 
              className="h-20 border-2 flex-col hover:bg-orange-50 hover:border-orange-300"
              onClick={() => {
                // Navigate to analytics or show coming soon
